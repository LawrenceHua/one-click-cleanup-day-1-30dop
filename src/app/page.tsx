...
export default function Page() {
  const tags = ["Bash", "Batch", "macOS", "Windows"];
  return (
    <main className="container">
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        <p style={{ color: '#94a3b8', marginBottom: '0.4rem' }}>Day 1 of 30 Days of Product</p>
        <h1 style={{ fontSize: '2.5rem', margin: '0 0 0.6rem 0', color: 'white' }}>One-Click Cleanup</h1>
        <p style={{ color: '#cbd5e1', lineHeight: 1.6 }}>Lightweight scripts to safely clean system and user caches on macOS and Windows. No GUI, no bloat.</p>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginTop: '1rem' }}>
          <Link href="/scripts/cleanup.command" className="btn btn-primary" download>
            Download macOS script
          </Link>
          <Link href="/scripts/cleanup.bat" className="btn btn-secondary" download>
